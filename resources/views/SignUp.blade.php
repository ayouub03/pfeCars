...
<body>
    <div id="container" class="active" style=" height: 77%;">
    ...
    <div class="content">
        ...
        <form method="POST" action="{{ route('signup') }}">
            ...
            <input type="tel" name="phone" placeholder="Tel:06 XX XX XX XX" required>
            @error('phone')
                <div class="alert alert-danger">{{ $message }}</div>
            @enderror
            ...
            <input type="text" name="cin" placeholder="CIN:AZ123456" required>
            @error('cin')
                <div class="alert alert-danger">{{ $message }}</div>
            @enderror
